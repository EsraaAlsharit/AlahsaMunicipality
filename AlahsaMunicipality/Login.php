...
<?php  } if(isset($_GET['status']) and $_GET['status']==="notfound"){ ?>
          <div  style="text-align: right;" class="alert alert-info alert-dismissible ">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            <strong>ملاحظة:</strong> لا يوجد مستخدم بهذا الاسم.
        </div>
<?php  }?>
     ...
     <hr id="hr1">
       ...
       <hr id="hr2">
        ...
        <form  action="forms/Action.php" method="POST"  >
                          ...
                          <!--span class="error" id="epwd" style="visibility: hidden">كلمة المرور غير صحيحة</span-->
            ...
            <div class="inUser form-group">
                ...
                <input  class="form-control" type="password" minlength="8" name="pwd" placeholder="كلمة المرور"
        ...
        <button id="btnLogin" onclick="window.location.href='Register.php'">مستخدم جديد</button>
        
		
		
        <!--div class="supDiv">
            <input type="checkbox" name="remembre" value="ggg" id="pub-site">
            <p id="lb" for="pub-site">تذكرني </p>
        </div-->
        <div  id="fotgt">
